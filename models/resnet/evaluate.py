"""
models/resnet/evaluate.py
=========================
Evaluate the saved ResNet checkpoint on the held-out test set.

Usage
-----
    cd experiments/
    python models/resnet/evaluate.py \
        --signals data/MITBIH/processed/signals.npy \
        --labels  data/MITBIH/processed/labels.npy  \
        --ckpt    models/resnet/saved_model/best_model.pth
"""
...
def get_args():
    parser = argparse.ArgumentParser(description='Evaluate 1-D ResNet')
